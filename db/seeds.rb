...
Quiz.all[0].questions.create(:content => "What reserved word do you use when creating a class?", :status => "approved")
...
Quiz.all[0].questions.create(:content => "Which of these is not a type of variable?", :status => "approved")
...
Quiz.all[0].questions.create(:content => "Which of these correctly tests to see if a is equal to 1?", :status => "approved")
...
Quiz.all[0].questions.create(:content => "What casing is used with constants?", :status => "approved")
...
Quiz.all[0].questions.create(:content => "What is another name for an instance of a class?", :status => "approved")
...
Quiz.all[0].questions.create(:content => "What character denotes a global variable?", :status => "approved")
...
Quiz.all[0].questions.create(:content => "What is the process of figuring out the how the real world is represented in your object oriented program?", :status => "approved")
...
Quiz.all[0].questions.create(:content => "When you have a lot of values, what can you use instead of the 'if' statement?", :status => "approved")
...
Quiz.all[1].questions.create(:content => "What string method removes whitespace at the beginning and end of a string?", :status => "approved")
...
Quiz.all[1].questions.create(:content => "What special character represents a backspace?", :status => "approved")
...
Quiz.all[1].questions.create(:content => "What method allows you to get a string from standard input?", :status => "approved")
...
Quiz.all[1].questions.create(:content => "What method puts the letters of a string in reverse order?", :status => "approved")
...
Quiz.all[1].questions.create(:content => "What string operator multiplies a string?", :status => "approved")
...
Quiz.all[1].questions.create(:content => "What method tells you what position in the string that letters or words occur in a string?", :status => "approved")
...
Quiz.all[2].questions.create(:content => "Generally speaking, what class are numbers with a decimal point?", :status => "approved")
...
Quiz.all[2].questions.create(:content => "How does the money library represent monetary values?", :status => "approved")
...
Quiz.all[2].questions.create(:content => "Which of these is the modulus operator?", :status => "approved")
...
Quiz.all[2].questions.create(:content => "What method converts a string with numbers in it to a floating point number?", :status => "approved")
...
Quiz.all[2].questions.create(:content => "What library would you use to do floating point math on decimals?", :status => "approved")
...
Quiz.all[2].questions.create(:content => "Which operator checks to see that the operand on the left is less than the operand on the right?", :status => "approved")
...
Quiz.all[2].questions.create(:content => "What method converts a string with a number in it to a Fixnum?", :status => "approved")
...
Quiz.all[2].questions.create(:content => "Which of these methods will return a random number between 0 and 1000?", :status => "approved")
...
array = [1, 2, 3, 4, 5]
array.select { |item| item >= 3 }", :status => "approved")
...
Quiz.all[3].questions.create(:content => "What does the pop method do to an array?", :status => "approved")
...
Quiz.all[3].questions.create(:content => "What method reverses the items in an array?", :status => "approved")
...
Quiz.all[3].questions.create(:content => "What does the & operator return from two arrays?", :status => "approved")
...
User.new(:name => "Avi Flombaum", :email => "123@abc.com", :password => "test").save(:validate => false)

User.new(:name => "Jennifer Campbell", :email => "jennifer.campbell@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "Alisa Chang", :email => "alisa.chang@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "Kristen Curtis", :email => "kristen.curtis@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "Sarah Duve", :email => "sarah.duve@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "Jennifer Eisenberg", :email => "jennifer.eisenberg@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "Katie Ishibashi", :email => "katie.ishibashi@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "Kirin Masood", :email => "kirin.masood@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "Ruthie Nachmany", :email => "ruthie.nachmany@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "Samantha Radocchia", :email => "samantha.radocchia@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "Anisha Vasandani", :email => "anisha.vasandani@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "Jack Altman", :email => "jack.altman@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "Alex Au", :email => "alex.au@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "Steven Brooks", :email => "steven.brooks@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "Joshua Collins", :email => "joshua.collins@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "Micah Corn", :email =>  "micah.corn@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "Thomas Deatherage", :email => "thomas.deatherage@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "Daniel Friedamn", :email => "daniel.friedman@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "Joseph Giralt", :email => "joe.giralt@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "Chris Gonzales", :email => "chris.gonzales@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "Maxwell Jacobson", :email => "maxwell.jacobson@gmail.com", :password => "test").save(:validate => false)
User.new(:name => "Mendel Kramer", :email => "mendel.kramer@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "Chris Lake", :email => "chris.lake@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "Carlos Lazo", :email => "carlos.lazo@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "George Lin", :email => "george.lin@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "David Manaster", :email => "david.manaster@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "Desmond Rawls", :email => "desmond.rawls@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "David Rodriguez", :email => "david.rodriguez@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "Matthew Schmaus", :email => "matthew.schmaus@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "Sagar Shah", :email => "sagar.shah@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "Jordan Trevino", :email => "jordan.trevino@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "Adam Waxman", :email => "adam.waxman@flatironschool.com", :password => "test").save(:validate => false)
User.new(:name => "Ning Yap", :email => "ning.yap@flatironschool.com", :password => "test").save(:validate => false)
