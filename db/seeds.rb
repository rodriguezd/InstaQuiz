...
User.create(:name => "Katie", :email => "katie.ishibashi@flatironschool.com", :password => "test")
User.create(:name => "Kirin", :email => "kirin.masood@flatironschool.com", :password => "test")
User.create(:name => "Ruthie", :email => "ruthie.nachmany@flatironschool.com", :password => "test")
User.create(:name => "Samantha", :email => "samantha.radocchia@flatironschool.com", :password => "test")
User.create(:name => "Anisha", :email => "anisha.vasandani@flatironschool.com", :password => "test")
User.create(:name => "Jack", :email => "jack.altman@flatironschool.com", :password => "test")
User.create(:name => "Alex", :email => "alex.au@flatironschool.com", :password => "test")
User.create(:name => "Steven", :email => "steven.brooks@flatironschool.com", :password => "test")
User.create(:name => "Joshua", :email => "joshua.collins@flatironschool.com", :password => "test")
User.create(:name => "Micah", :email =>  "micah.corn@flatironschool.com", :password => "test")
User.create(:name => "Thomas", :email => "thomas.deatherage@flatironschool.com", :password => "test")
User.create(:name => "Daniel", :email => "daniel.friedman@flatironschool.com", :password => "test")
User.create(:name => "Joseph", :email => "joe.giralt@flatironschool.com", :password => "test")
User.create(:name => "Chris Gonzales", :email => "chris.gonzales@flatironschool.com", :password => "test")
User.create(:name => "Maxwell", :email => "maxwell.jacobson@gmail.com", :password => "test")
User.create(:name => "Mendel", :email => "mendel.kramer@flatironschool.com", :password => "test")
User.create(:name => "Chris Lake", :email => "chris.lake@flatironschool.com", :password => "test")
User.create(:name => "Carlos", :email => "carlos.lazo@flatironschool.com", :password => "test")
User.create(:name => "George", :email => "george.lin@flatironschool.com", :password => "test")
User.create(:name => "David Manaster", :email => "david.manaster@flatironschool.com", :password => "test")
User.create(:name => "Desmond", :email => "desmond.rawls@flatironschool.com", :password => "test")
User.create(:name => "David Rodriguez", :email => "david.rodriguez@flatironschool.com", :password => "test")
User.create(:name => "Matthew", :email => "matthew.schmaus@flatironschool.com", :password => "test")
User.create(:name => "Sagar", :email => "sagar.shah@flatironschool.com", :password => "test")
User.create(:name => "Jordan", :email => "jordan.trevino@flatironschool.com", :password => "test")
